"use strict";
(self["webpackChunktei_shell"] = self["webpackChunktei_shell"] || []).push([["default-node_modules_angular_material_fesm2020_chips_mjs"],{
...
class MatChip extends _MatChipMixinBase {
  ...
  constructor(_changeDetectorRef, elementRef, _ngZone, _focusMonitor, _document, animationMode, _globalRippleOptions, tabIndex) {
    ...
    if (tabIndex != null) {
      var _parseInt;
      this.tabIndex = (_parseInt = parseInt(tabIndex)) !== null && _parseInt !== void 0 ? _parseInt : this.defaultTabIndex;
    }
    this._monitorFocus();
  }
  ngOnInit() {
  ...
  ngOnDestroy() {
    var _this$_actionChanges;
    this._focusMonitor.stopMonitoring(this._elementRef);
    (_this$_actionChanges = this._actionChanges) === null || _this$_actionChanges === void 0 ? void 0 : _this$_actionChanges.unsubscribe();
    this.destroyed.emit({
      chip: this
    });
  ...
  _isRippleDisabled() {
    var _this$_globalRippleOp;
    return this.disabled || this.disableRipple || this._animationsDisabled || this._isBasicChip || !!((_this$_globalRippleOp = this._globalRippleOptions) !== null && _this$_globalRippleOp !== void 0 && _this$_globalRippleOp.disabled);
  }
...
class MatChipOption extends MatChip {
  constructor() {
    ...
    this._chipListHideSingleSelectionIndicator = (_this$_defaultOptions = (_this$_defaultOptions2 = this._defaultOptions) === null || _this$_defaultOptions2 === void 0 ? void 0 : _this$_defaultOptions2.hideSingleSelectionIndicator) !== null && _this$_defaultOptions !== void 0 ? _this$_defaultOptions : false;
...
class MatChipSet extends _MatChipSetMixinBase {
  ...
  _setUpFocusManagement() {
    ...
    (_this$_dir = this._dir) === null || _this$_dir === void 0 ? void 0 : _this$_dir.change.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.takeUntil)(this._destroyed)).subscribe(direction => this._keyManager.withHorizontalOrientation(direction));
  }
  /**
...
class MatChipListbox extends MatChipSet {
  constructor() {
    var _this$_defaultOptions3, _this$_defaultOptions4;
    super(...arguments);
    /**
    ...
    this._hideSingleSelectionIndicator = (_this$_defaultOptions3 = (_this$_defaultOptions4 = this._defaultOptions) === null || _this$_defaultOptions4 === void 0 ? void 0 : _this$_defaultOptions4.hideSingleSelectionIndicator) !== null && _this$_defaultOptions3 !== void 0 ? _this$_defaultOptions3 : false;
...
class MatChipGrid extends _MatChipGridMixinBase {
  ...
  get required() {
    ...
    return (_ref = (_this$_required = this._required) !== null && _this$_required !== void 0 ? _this$_required : (_this$ngControl = this.ngControl) === null || _this$ngControl === void 0 ? void 0 : (_this$ngControl$contr = _this$ngControl.control) === null || _this$ngControl$contr === void 0 ? void 0 : _this$ngControl$contr.hasValidator(_angular_forms__WEBPACK_IMPORTED_MODULE_13__.Validators.required)) !== null && _ref !== void 0 ? _ref : false;
  }
  set required(value) {
    this._required = (0,_angular_cdk_coercion__WEBPACK_IMPORTED_MODULE_2__.coerceBooleanProperty)(value);
    this.stateChanges.next();
  ...
  setDescribedByIds(ids) {
    var _this$_chipInput;
    // We must keep this up to date to handle the case where ids are set
    // before the chip input is registered.
    this._ariaDescribedbyIds = ids;
    (_this$_chipInput = this._chipInput) === null || _this$_chipInput === void 0 ? void 0 : _this$_chipInput.setDescribedByIds(ids);
  }
  /**
   * Implemented as part of ControlValueAccessor.
   * @docs-private
...
//# sourceMappingURL=default-node_modules_angular_material_fesm2020_chips_mjs.js.map